...
Реализуйте с помощью одной из связей возможность получения книги «на руки» пользователем (для этого придется удалить таблицы из БД,
...
> **Информация по запуску:** укажите в файле appsettings.json строку подключения к вашему экземпляру Microsoft SQL Express.
